...
public class RunSequenceCommand extends Command {
  ...
  // public RunSequenceCommand(ElevatorSubsystem elevatorSubsystem, ArmSubsystem armSubsystem,
  ...
  public void runStateMachine() {
    ...
    if (sequence == null) {
      System.out.println(
          "RunSequenceCommand: Sequence not found for the combination of "
    ...
    System.out.println(
        "RunSequenceCommand: Sequence chosen "
            + sequence
            + " "
            + SequenceManager.getGamePieceSelection()
            + " "
