...
public class ScoreCoralTransitions {
  private static final Object transitionTable[][] = {
    ...
    {SequenceState.WAITING,                 SequenceInput.BUTTON_RELEASED,            "outTaking",                      SequenceState.OUTTAKING_CORAL},
    {SequenceState.OUTTAKING_CORAL,         SequenceInput.CORAL_ABSENT,               "stopRollers",                    SequenceState.STOPPING_ROLLERS},
