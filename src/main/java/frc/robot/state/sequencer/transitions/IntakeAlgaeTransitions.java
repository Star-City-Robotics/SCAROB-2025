...
public class IntakeAlgaeTransitions {
    private static final Object transitionTable[][] = {
        ...
        {SequenceState.WAITING,                 SequenceInput.BUTTON_RELEASED,            "intakeRollers",              SequenceState.INTAKING_ROLLERS},
        ...
        {SequenceState.MOVING_SLAPDOWN_OUT_2,   SequenceInput.SLAPDOWN_OUT,               "moveElevatorHome",           SequenceState.MOVING_ELEVATOR_HOME},
        {SequenceState.MOVING_ELEVATOR_HOME,    SequenceInput.ELEVATOR_HOME,              "resetState",                 SequenceState.HOME},
